...
1) Называйте файлы осмысленно, с указанием названия работы и автора. Можно оформить в виде иерархического дерева:
    Папка - предмет
    |
    |- Папка - работа
        |
...
5) Пишите названия файлов и папок на английском, не знаю почему, просто так.
